...
```bash
git clone https://github.com/drewstopherlee/technitium-allow.git
```

2. Open Chrome and go to `chrome://extensions/`.
3. Enable *Developer mode*.
4. Click *Load unpacked* and select the repository folder (or `src/`).

---

## Usage

1. Browse to a site. If a domain fails to resolve it will appear in the popup history.
